...
class setCatalanLang():
    """ Objects imported created in engllish, pass it to Catalan... """
    def __call__(self):
        ###
        ###
        results = []
...
class ModifyCategory3():
    """ Error in copy&paste code makes bad import in category. We need to swap values between CAT_ADS and CAT3 """
    def __call__(self):
